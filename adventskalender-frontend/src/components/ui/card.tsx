...
const cardVariants = cva('rounded-lg transition-all duration-200', {
    variants: {
        variant: {
            ...
            'glass-success': 'glass glass-success text-card-foreground',
            'glass-warning': 'glass glass-warning text-card-foreground',
            'glass-error': 'glass glass-error text-card-foreground',
        },
    },
    defaultVariants: {
        variant: 'glass',
